...
{
    public TestEnemyModel crash;
    public GameObject box;
    public Node goalNode;
    public Node startNode;
    public float nodeOvSphereRadius;
    Collider[] _colliders;
    ...
    Node GetStartNode()
    {
        int count = Physics.OverlapSphereNonAlloc(crash.transform.position, nodeOvSphereRadius, _colliders, maskNodes);
