...
{
    [CreateAssetMenu(fileName = "Is In Boss Room?", menuName = "_main/Conditions/Boss Conditions/Is In Boss Room?")]
    public class IsInBossRoom : StateCondition
    {
        public override bool CompleteCondition(EntityModel model)
        {
            ...
            return bossModel.GetData().IsInBossRoom;
